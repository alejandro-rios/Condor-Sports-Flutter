...
import 'package:condor_sports_flutter/features/teams_list/domain/interactors/get_teams_by_league_interactor.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      // When
      final result = await interactor(Params(leagueId: tLeagueId));
